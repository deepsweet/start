...
export type StartPlugin = (props: StartPluginPropsBefore) => StartPluginPropsOut | Promise<StartPluginPropsOut> | void | Promise<void>

export default (name: string, pluginFn: StartPluginFn): StartPlugin => async ({ reporter, ...rest }) => {
  try {
